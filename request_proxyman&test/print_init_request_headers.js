...
const tempDir = '/Users/hoangquan/Downloads/temp_print_headers';
...
allFiles.forEach(filePath => {
    try {
        ...
        // Không lọc thô, parse luôn (file nhỏ nên không lo crash)
        ...
        if (url.toLowerCase().includes('user/init')) {
            found++;
            console.log(`\n=========================================`);
            console.log(`[KHỚP] File: ${path.relative(tempDir, filePath)}`);
            console.log(`URL: ${url}`);
